    ...
    <div className={cn('relative', className)}>
      ...
      <div
        className={cn(
          ...
          'bg-gradient-to-b from-white via-white/80 to-transparent dark:from-gray-900 dark:via-gray-900/80',
      ...
      <div
        className={cn(
          ...
          'bg-gradient-to-t from-white via-white/80 to-transparent dark:from-gray-900 dark:via-gray-900/80',
